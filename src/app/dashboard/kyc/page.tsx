...
function KYCPageSkeleton() {
  ...
  export default function KYCPage() {
    ...
    const currentSubmission = kycStatus !== 'not_submitted' ? {
      ...mockKYCSubmission,
      status: kycStatus,
      rejectionReason: kycStatus === 'rejected' ? 'Document quality is poor. Please upload clearer images.' : null
    } : null
